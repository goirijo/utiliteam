...
int main(int argc, char *argv[])
{
    ...
    MultTable multiplication_table = make_multiplication_table(pt_group);
...
//test abstract Operation construction
    std::shared_ptr<MultTable> pt_group_multiplaction_table_ptr = std::make_shared<MultTable>(multiplication_table);
...
//test transformation
    ...
    std::vector<AbstractSymOp> abstract_pt_group = transform_representation(pt_group);
